...
head_jquery_pc("Krona Koblenz Spa - Manutenzione PL", "");
...
<ul>
    ...
    <li><img src="../bcreader.gif" />&nbsp;<a href=<?php print(CONFIG::$BASE_URL . "askpl-banc.php"); ?>>Gestione bancali</a></li>
    <li><img src="../bcreader.gif" />&nbsp;<a href=<?php print(CONFIG::$BASE_URL . "askpl-banc-rep.php"); ?>>Riassegnazione bancali per reparto</a></li>
