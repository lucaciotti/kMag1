...
function mostraDistinta($articolo, $quantita, $descrizion, $lottopadre, $idRiga) {
	...
	for($j = 1; $j <= $nCompLen; $j++) {
		...
		$Query .= "from magart inner join maggiac on maggiac.articolo == magart.codice and maggiac.magazzino == '00002' and maggiac.esercizio == '".$anno."' ";
